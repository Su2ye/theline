...
const DEMO_MARKERS: MeetMarker[] = [
  { id: '1', createdAt: Date.now() - 100000000, lat: 39.9150, lng: 116.4040, myNote: '胡同里的咖啡店', myPhoto: null, peerNote: '那天阳光很好', peerPhoto: null },
  { id: '2', createdAt: Date.now() - 200000000, lat: 39.9250, lng: 116.4140, myNote: '', myPhoto: null, peerNote: '', peerPhoto: null },
  { id: '3', createdAt: Date.now() - 300000000, lat: 39.9350, lng: 116.3940, myNote: '一起看了展', myPhoto: null, peerNote: '下次还要来', peerPhoto: null },
]
...
export default function App() {
  ...
  const [markers, setMarkers] = useState<MeetMarker[]>(DEMO_MARKERS)
  ...
  const stats = useMemo<LineStats>(() => {
    if (paired) return computeStats(markers, pairCreatedAt)
    return computeStats(markers)
